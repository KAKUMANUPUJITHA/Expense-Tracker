...
# grid placement
cur_date.grid(row=3, column=1, sticky=EW, padx=(10, 3))
submit_btn.grid(row=0, column=2, sticky=EW, padx=(10, 3))
clr_btn.grid(row=1, column=2, sticky=EW, padx=(10, 3))
quit_btn.grid(row=2, column=2, sticky=EW, padx=(10, 3))
total_bal.grid(row=0, column=3, sticky=EW, padx=(10, 3))
update_btn.grid(row=1, column=3, sticky=EW, padx=(10, 3))
del_btn.grid(row=2, column=3, sticky=EW, padx=(10, 3))
